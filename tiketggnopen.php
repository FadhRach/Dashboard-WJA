...
<html lang="en">
    <head>
        ...
        <!-- Custom bawaan CSS -->
        <link rel="stylesheet" href="css/newcss.css" rel="stylesheet" type="text/css">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="panel panel-primary">
                            <div class="panel-heading" id="totaltiket_p">
                                <div class="row">
                                    <div class="col-xs-3">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="panel panel-green">
                            <div class="panel-heading" id="stopclock_p">
                                <div class="row">
                                    <div class="col-xs-3">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="panel panel-yellow">
                            <div class="panel-heading" id="tiketpm_p">
                                <div class="row">
                                    <div class="col-xs-3">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="panel panel-red">
                            <div class="panel-heading" id="ggnopen_p">
                                <div class="row">
                                    <div class="col-xs-3">
                            ...
                            <div class="container-fluid">
                                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                                    <table class="w-full text-sm text-left text-gray-500">
                                        ...
                                        <?php
                                            $sql="SELECT * FROM wja 
                                            WHERE ticketcategories = ' Technical Complaint '
                                            AND ticket_status IN (' Open ', ' Re-Open ')
