# mar/15/2023 05:02:41 by RouterOS 6.48.1
...
/interface vlan
add interface=sfp-sfpplus6 name=2020240094-BPSDM vlan-id=102
add interface=sfp-sfpplus6 name=2020240165-DPMPTSP vlan-id=103
add interface=sfp-sfpplus6 name=2020240168-DLH vlan-id=104
add interface=sfp-sfpplus6 name=2020240178-DISPERKIM vlan-id=105
add interface=sfp-sfpplus6 name=2020240186-DISPUSIPDA vlan-id=106
add interface=sfp-sfpplus6 name=2020240189-BPBD vlan-id=107
add interface=sfp-sfpplus6 name="2020240190-BADAN PENGHUBUNG" vlan-id=100
add interface=sfp-sfpplus6 name=2020240191-BP2D vlan-id=108
...
add interface=sfp-sfpplus6 name="2020240221-RS PARU" vlan-id=109
add interface=sfp-sfpplus6 name=2020240222-RSJ vlan-id=110
...
add interface=sfp-sfpplus6 name="2021240541-RSUD KESEHATAN KERJA" vlan-id=111
add interface=sfp-sfpplus6 name="2021240544-UPTD PENGELOLAAN SAMPAH" vlan-id=\
    112
add interface=sfp-sfpplus6 name="2021240546-UPTD P3JB" vlan-id=113
add interface=sfp-sfpplus6 name="2021240823-CADISDIK WIL VIII" vlan-id=116
add interface=sfp-sfpplus6 name="2021240828-CADISDIK WIL X" vlan-id=117
add interface=sfp-sfpplus6 name="2021240829-CADISDIK WIL XI" vlan-id=118
add interface=sfp-sfpplus6 name=2021240832-UPTD_DISDIK_XII vlan-id=119
add interface=sfp-sfpplus6 name="2021240847-UPTD PPKS" vlan-id=120
add interface=sfp-sfpplus6 name="2021240859-UPTD PSRPD MENSENETRUWITU" \
    vlan-id=121
add interface=sfp-sfpplus6 name="2021240869-UPTD BBH" vlan-id=122
add interface=sfp-sfpplus6 name="2021240872-UPTD BPSBPTH" vlan-id=123
add interface=sfp-sfpplus6 name="2021240873-UPTD BPTPH" vlan-id=124
add interface=sfp-sfpplus6 name="2021240876-UPTD PPMPP" vlan-id=125
add interface=sfp-sfpplus6 name="2021240877-UPTD PSDKPWU" vlan-id=126
add interface=sfp-sfpplus6 name="2021240881-CADISHUT WIL I" vlan-id=127
add interface=sfp-sfpplus6 name="2021240883-CADISHUT WIL II" vlan-id=128
...
add interface=sfp-sfpplus6 name="2021241005-UPTD P3LLAJ WIL II" vlan-id=129
add interface=sfp-sfpplus6 name="2021241007-UPTD P3LLAJ WIL IV" vlan-id=138
add interface=sfp-sfpplus6 name="2021241008-UPTD P3LLASDP" vlan-id=131
add interface=sfp-sfpplus6 name="2021241045-UPTD PSDA WS CILIWUNG-CISADANE" \
    vlan-id=132
add interface=sfp-sfpplus6 name="2021241046-UPTD PSDA WS CISADEA-CIBARENO" \
    vlan-id=133
add interface=sfp-sfpplus6 name="2021241047-UPTD PSDA WS CITARUM" vlan-id=134
add interface=sfp-sfpplus6 name="2021241139-UPTD PSDA WS CITANDUY" vlan-id=\
    139
add interface=sfp-sfpplus6 name="2021241150-CABANG DESDM WIL II BGR" vlan-id=\
    135
add interface=sfp-sfpplus6 name="2021241156-CABANG DESDM WIL III PWK" \
    vlan-id=136
add interface=sfp-sfpplus6 name="2021241312-CABANG DESDM WIL IV BDG" vlan-id=\
    137
add interface=sfp-sfpplus6 name="2021241320-UPTD P3W" vlan-id=141
...
add interface=sfp-sfpplus6 name="2023351738-MESS BAPENDA" vlan-id=142
...
add max-limit=110M/110M name=2023351738-MES_BAPENDA target=\
    "2023351738-MESS BAPENDA"
...
add max-limit=110M/110M name=BPPD target=2020240191-BP2D
...
add max-limit=110M/110M name=DISDUKCAPIL target=2020240180-DISDUKCAPIL
add max-limit=110M/110M name=DISPARBUD target=2020240188-DISPARBUD
...
add max-limit=21M/21M name=UPTD_BPMKP target="2021240874-UPTD BPMKP"
...
add max-limit=21M/21M name=UPTD_BPSMB_AMDK target=\
...
add max-limit=21M/21M name=UPTD_PPMPP target="2021240876-UPTD PPMPP"
...
add max-limit=110M/110M name=UPTD_RUMKIT_DKK target=\
...
add address=172.20.14.1/30 interface=2020240186-DISPUSIPDA network=\
    172.20.14.0
add address=172.20.20.1/30 disabled=yes interface=2020240193-BAPENDA network=\
    172.20.20.0
...
add address=172.20.102.1/30 interface=2023345555-MESJID_PUSDAI network=\
    172.20.102.0
add address=172.20.117.1/30 interface="2023351738-MESS BAPENDA" network=\
    172.20.117.0
/ip dns
...
add action=dst-nat chain=dstnat comment="2023351738 - Mess Bapenda" \
    dst-address=103.122.5.152 dst-port=8036 protocol=tcp to-addresses=\
    172.20.117.2 to-ports=8291
add action=src-nat chain=srcnat dst-address=172.20.117.2 dst-port=8291 \
    protocol=tcp to-addresses=172.20.117.2
add action=dst-nat chain=dstnat comment=\
...
add distance=1 dst-address=10.147.11.0/24 gateway=172.20.117.2
