# jan/15/2024 05:00:02 by RouterOS 6.48.4
...
add action=src-nat chain=srcnat dst-address=172.169.0.31 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="CSR DESA BUNGKO" dst-address=\
    123.231.237.114 dst-port=8213 protocol=tcp to-addresses=172.169.0.68 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.68 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA PADAMUKTI" dst-address=\
    123.231.237.114 dst-port=8214 protocol=tcp to-addresses=172.169.0.119 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.119 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA PANYADAP" dst-address=\
    123.231.237.114 dst-port=8215 protocol=tcp to-addresses=172.169.0.89 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.89 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA LEBAK AGUNG" dst-address=\
    123.231.237.116 dst-port=8216 protocol=tcp to-addresses=172.169.0.49 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.49 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA CINTAMANIK GRT" dst-address=\
    123.231.237.116 dst-port=8217 protocol=tcp to-addresses=172.169.0.21 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.21 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA KENDAN NAGREG" dst-address=\
    123.231.237.116 dst-port=8218 protocol=tcp to-addresses=172.169.0.88 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.88 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA PAGELARAN SELAGEDANG" \
    dst-address=123.231.237.114 dst-port=8219 protocol=tcp to-addresses=\
    172.169.0.85 to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.85 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA SUKAKERTA" dst-address=\
    123.231.237.114 dst-port=8220 protocol=tcp to-addresses=172.169.0.121 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.121 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA LENGGAHSARI" dst-address=\
    123.231.237.114 dst-port=8221 protocol=tcp to-addresses=172.169.0.29 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.29 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA JAYALAKSANA" dst-address=\
    123.231.237.116 dst-port=8222 protocol=tcp to-addresses=172.169.0.28 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.28 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA KARANG BAHAGIA KAB.BEKASI" \
    dst-address=123.231.237.114 dst-port=8223 protocol=tcp to-addresses=\
    172.169.0.30 to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.30 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA SUKARINGIN" dst-address=\
    123.231.237.114 dst-port=8224 protocol=tcp to-addresses=172.169.0.75 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.75 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA CINTAMANIK BOGOR" dst-address=\
    123.231.237.114 dst-port=8225 protocol=tcp to-addresses=172.169.0.79 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.79 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA CIDOKOM" dst-address=\
    123.231.237.114 dst-port=8226 protocol=tcp to-addresses=172.169.0.5 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.5 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA PINGKU" dst-address=\
    123.231.237.114 dst-port=8227 protocol=tcp to-addresses=172.169.0.122 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.122 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA KARANGANYAR LEUWIGOONG" \
    dst-address=123.231.237.114 dst-port=8228 protocol=tcp to-addresses=\
    172.169.0.22 to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.22 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA SINGABANGSA" dst-address=\
    123.231.237.114 dst-port=8229 protocol=tcp to-addresses=172.169.0.38 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.38 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA CIGADOG" dst-address=\
    123.231.237.114 dst-port=8230 protocol=tcp to-addresses=172.169.0.59 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.59 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA MEKARWANGI TALEGONG" \
    dst-address=123.231.237.114 dst-port=8231 protocol=tcp to-addresses=\
    172.169.0.123 to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.123 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA BOJONGINDAH" dst-address=\
    123.231.237.114 dst-port=8232 protocol=tcp to-addresses=172.169.0.37 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.37 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA PABANGBON" dst-address=\
    123.231.237.114 dst-port=8233 protocol=tcp to-addresses=172.169.0.4 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.4 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA PANCAWATI" dst-address=\
    123.231.237.114 dst-port=8234 protocol=tcp to-addresses=172.169.0.35 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.35 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA MEKARJAYA" dst-address=\
    123.231.237.114 dst-port=8235 protocol=tcp to-addresses=172.169.0.31 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.31 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA WARGAJAYA SUKAMAKMUR" \
    dst-address=123.231.237.114 dst-port=8236 protocol=tcp to-addresses=\
    172.169.0.2 to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.2 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA JUNGJANGWETAN" dst-address=\
    123.231.237.114 dst-port=8237 protocol=tcp to-addresses=172.169.0.13 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.13 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA SUKAMUKTI CILAWU" dst-address=\
    123.231.237.114 dst-port=8238 protocol=tcp to-addresses=172.169.0.15 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.15 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA CIOMAS" dst-address=\
    123.231.237.114 dst-port=8239 protocol=tcp to-addresses=172.169.0.3 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.3 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA SUKASENANG" dst-address=\
    123.231.237.114 dst-port=8240 protocol=tcp to-addresses=172.169.0.87 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.87 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA TANJUNGJAYA" dst-address=\
    123.231.237.114 dst-port=8300 protocol=tcp to-addresses=172.169.0.81 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.81 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA SUKALILAH" dst-address=\
    123.231.237.115 dst-port=8241 protocol=tcp to-addresses=172.169.0.112 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.112 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA NEGLASARI" dst-address=\
    123.231.237.114 dst-port=8242 protocol=tcp to-addresses=172.169.0.125 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.125 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA GIRIMULYA" dst-address=\
    123.231.237.114 dst-port=8243 protocol=tcp to-addresses=172.169.0.51 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.51 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA SUKARAHARJA" dst-address=\
    123.231.237.114 dst-port=8244 protocol=tcp to-addresses=172.169.0.26 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.26 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA SAGANTEN" dst-address=\
    123.231.237.114 dst-port=8245 protocol=tcp to-addresses=172.169.0.12 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.12 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA KARYAMUKTI" dst-address=\
    123.231.237.114 dst-port=8246 protocol=tcp to-addresses=172.169.0.43 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.43 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA KUBANG" dst-address=\
    123.231.237.114 dst-port=8247 protocol=tcp to-addresses=172.169.0.11 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.11 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA MEKARJAYA CIDAUN" dst-address=\
    123.231.237.114 dst-port=8248 protocol=tcp to-addresses=172.169.0.6 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.6 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA SUKAPURA" dst-address=\
    123.231.237.114 dst-port=8249 protocol=tcp to-addresses=172.169.0.84 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.84 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA SUKAMULYA TALEGONG" \
    dst-address=123.231.237.114 dst-port=8250 protocol=tcp to-addresses=\
    172.169.0.7 to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.7 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA KARANGSARI CIKELET" \
    dst-address=123.231.237.114 dst-port=8251 protocol=tcp to-addresses=\
    172.169.0.108 to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.108 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA TIPAR CIKELET" dst-address=\
    123.231.237.114 dst-port=8252 protocol=tcp to-addresses=172.169.0.8 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.8 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA MEKARWANGI CIHURIP" \
    dst-address=123.231.237.116 dst-port=8255 protocol=tcp to-addresses=\
    172.169.0.14 to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.14 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA SUKAWANGI SINGAJAYA" \
    dst-address=123.231.237.116 dst-port=8256 protocol=tcp to-addresses=\
    172.169.0.16 to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.16 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA MULYAJAYA BANJARWANGI" \
    dst-address=123.231.237.116 dst-port=8257 protocol=tcp to-addresses=\
    172.169.0.17 to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.17 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA KARANG AGUNG" dst-address=\
    123.231.237.116 dst-port=8258 protocol=tcp to-addresses=172.169.0.18 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.18 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment=SUKAHATI_CILAWU dst-address=\
    123.231.237.116 dst-port=8259 protocol=tcp to-addresses=172.169.0.19 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.19 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA JUNJANGWETAN" dst-address=\
    123.231.237.116 dst-port=8260 protocol=tcp to-addresses=172.169.0.13 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.13 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA PUSAKAJAYA SUBANG" dst-address=\
    123.231.237.116 dst-port=8261 protocol=tcp to-addresses=172.169.0.20 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.20 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA SERANGPANJANG SUBANG" \
    dst-address=123.231.237.116 dst-port=8262 protocol=tcp to-addresses=\
    172.169.0.23 to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.23 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA NAJATEN" dst-address=\
    123.231.237.116 dst-port=8263 protocol=tcp to-addresses=172.169.0.62 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.62 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA BOJONGKONENG" dst-address=\
    123.231.237.116 dst-port=8264 protocol=tcp to-addresses=172.169.0.90 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.90 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA SUMURBANDUNG" dst-address=\
    123.231.237.116 dst-port=8265 protocol=tcp to-addresses=172.169.0.91 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.91 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA SAGULING" dst-address=\
    123.231.237.116 dst-port=8266 protocol=tcp to-addresses=172.169.0.73 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.73 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA CIDOKOM" dst-address=\
    123.231.237.116 dst-port=8267 protocol=tcp to-addresses=172.169.0.5 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.5 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA TALAGAWANGI" dst-address=\
    123.231.237.116 dst-port=8268 protocol=tcp to-addresses=172.169.0.24 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.24 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA BABELAN" dst-address=\
    123.231.237.116 dst-port=8275 protocol=tcp to-addresses=172.169.0.120 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.120 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
add action=dst-nat chain=dstnat comment="DESA PABANGBON" dst-address=\
    123.231.237.116 dst-port=8276 protocol=tcp to-addresses=172.169.0.4 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.169.0.4 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
/ip route
...
add local-address=172.169.0.1 name=SUKAHARJA password=P4ssword2023 \
    remote-address=172.169.0.26
...
add local-address=172.169.0.1 name=NAJATEN password=P4ssword2023 \
    remote-address=172.169.0.62
add local-address=172.169.0.1 name=CIGADOG password=P4ssword2023 \
...
add local-address=172.169.0.1 name=LEBAKAGUNG password=P4ssword2023 \
    remote-address=172.169.0.49
add local-address=172.169.0.1 name=KARYAMUKTI password=P4ssword2023 \
    remote-address=172.169.0.43
add local-address=172.169.0.1 name=SLBN_BUNGA password=P4ssword2023 \
...
add local-address=172.169.0.1 name=SINGABANGSA password=P4ssword2023 \
    remote-address=172.169.0.38
add local-address=172.169.0.1 name=CIKUTAMAHI password=P4ssword2023 \
    remote-address=172.169.0.36
add local-address=172.169.0.1 name=PANCAWATI password=P4ssword2023 \
...
add local-address=172.169.0.1 name=KARANGBAHAGIA password=P4ssword2023 \
    remote-address=172.169.0.30
...
add local-address=172.169.0.1 name=PADAHURIP password=P4ssword2023 \
    remote-address=172.169.0.25
add local-address=172.169.0.1 name=TALAGAWANGI password=P4ssword2023 \
    remote-address=172.169.0.24
add local-address=172.169.0.1 name=CINTAMEKAR_SERANGPANJANG password=\
    P4ssword2023 remote-address=172.169.0.23
add local-address=172.169.0.1 name=KARANGANYAR password=P4ssword2023 \
    remote-address=172.169.0.22
add local-address=172.169.0.1 name=CINTAMANIK password=P4ssword2023 \
    remote-address=172.169.0.21
add local-address=172.169.0.1 name=PUSAKAJAYA_SBG password=P4ssword2023 \
    remote-address=172.169.0.20
add local-address=172.169.0.1 name=KARANGAGUNG password=P4ssword2023 \
    remote-address=172.169.0.18
add local-address=172.169.0.1 name=MULYAJAYA_BANJARWANGI password=\
    P4ssword2023 remote-address=172.169.0.17
add local-address=172.169.0.1 name=SUKAWANGI_SINGAJAYA password=P4ssword2023 \
    remote-address=172.169.0.16
add local-address=172.169.0.1 name=SUKAMUKTICILAWU password=P4ssword2023 \
    remote-address=172.169.0.15
add local-address=172.169.0.1 name=MEKARWANGI_CIHURIP2 password=P4ssword2023 \
    remote-address=172.169.0.14
add local-address=172.169.0.1 name=JUNGJANGWETAN password=P4ssword2023 \
    remote-address=172.169.0.13
add local-address=172.169.0.1 name=SAGANTEN password=P4ssword2023 \
    remote-address=172.169.0.12
add local-address=172.169.0.1 name=KUBANG password=P4ssword2023 \
    remote-address=172.169.0.11
add local-address=172.169.0.1 name=CIBODAS password=P4ssword2023 \
    remote-address=172.169.0.10
add local-address=172.169.0.1 name=MEKARWANGI_CIHURIP password=P4ssword2023 \
    remote-address=172.169.0.9
add local-address=172.169.0.1 name=TIPAR_CIKELET password=P4ssword2023 \
    remote-address=172.169.0.8
add local-address=172.169.0.1 name=SUKAMULYA_TALEGONG password=P4ssword2023 \
    remote-address=172.169.0.7
add local-address=172.169.0.1 name=MEKARJAYA_CIDAUN password=P4ssword2023 \
    remote-address=172.169.0.6
add local-address=172.169.0.1 name=CIDOKOM password=P4ssword2023 \
    remote-address=172.169.0.5
add local-address=172.169.0.1 name=PABANGBON password=P4ssword2023 \
...
add local-address=172.169.0.1 name=SUKARINGIN password=P4ssword2023 \
    remote-address=172.169.0.75
...
add disabled=yes local-address=172.169.0.1 name=LEUWIKOLOT password=\
    P4ssword2023 remote-address=172.169.0.77
add local-address=172.169.0.1 name=CINTAMANIKBGR password=P4ssword2023 \
    remote-address=172.169.0.79
add disabled=yes local-address=172.169.0.1 name=KARYAJAYA password=\
    P4ssword2023 remote-address=172.169.0.80
add local-address=172.169.0.1 name=TANJUNGJAYA password=P4ssword2023 \
    remote-address=172.169.0.81
...
add local-address=172.169.0.1 name=SUKASENANG password=P4ssword2023 \
    remote-address=172.169.0.87
...
add local-address=172.169.0.1 name=KARANGSARI_CIKELET password=P4ssword2023 \
...
add local-address=172.169.0.1 name=SUKALILAH password=P4ssword2023 \
    remote-address=172.169.0.112
...
add local-address=172.169.0.1 name=GIRIMULYA password=P4ssword2023 \
...
add local-address=172.169.0.1 name=SUKAKERTA1 password=P4ssword2023 \
    remote-address=172.169.0.121
add local-address=172.169.0.1 name=PINGKU password=P4ssword2023 \
    remote-address=172.169.0.122
add local-address=172.169.0.1 name=MEKARWANGITALEGONG password=P4ssword2023 \
    remote-address=172.169.0.123
add local-address=172.169.0.1 name=MEKARMUKTITALEGONG password=P4ssword2023 \
    remote-address=172.169.0.124
add local-address=172.169.0.1 name=BOJONGINDAH password=P4ssword2023 \
    remote-address=172.169.0.37
add local-address=172.169.0.1 name=NEGLASARI password=P4ssword2023 \
    remote-address=172.169.0.125
add local-address=172.169.0.1 name=remote password=remote remote-address=\
    172.169.0.126
add local-address=172.169.0.1 name=SUKAHATI_CILAWU password=P4ssword2023 \
