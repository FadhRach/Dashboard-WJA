# jan/15/2023 04:59:51 by RouterOS 6.48.4
...
add action=src-nat chain=srcnat dst-address=192.169.201.250 dst-port=443 \
    protocol=tcp to-addresses=172.169.0.1
add action=src-nat chain=srcnat comment="D-NAT KWS KARANGHARJA" dst-address=\
...
add action=src-nat chain=srcnat comment="D-NAT CCR CT CIERENG SUBANG" \
    ...
    150.150.150.1
add action=src-nat chain=srcnat comment="D-NAT CCR CT CIERENG SUBANG" \
    disabled=yes dst-address=172.169.0.33 dst-port=8291 protocol=tcp \
    to-addresses=172.169.0.32
...
add action=dst-nat chain=dstnat comment=CIERENG disabled=yes dst-address=\
    123.231.237.115 dst-port=8090 protocol=tcp to-addresses=172.169.0.33 \
    to-ports=8293
add action=src-nat chain=srcnat comment="D-NAT CCR CT CIERENG SUBANG" \
...
add action=dst-nat chain=dstnat comment="MKT KARANGMULYA" dst-address=\
    123.231.237.115 dst-port=8230 protocol=tcp to-addresses=172.169.0.44 \
    to-ports=8240
add action=src-nat chain=srcnat dst-address=172.169.0.44 dst-port=8240 \
    protocol=tcp to-addresses=172.169.0.1
...
/ppp secret
add disabled=yes local-address=172.169.0.1 name=sbgciereng1 password=\
    sbgciereng1 profile=default-encryption remote-address=172.169.0.5
add disabled=yes local-address=172.169.0.1 name=sbgciereng2 password=\
    sbgciereng2 profile=default-encryption remote-address=172.169.0.6
add disabled=yes local-address=172.169.0.1 name=sukamajukng password=\
    sukamajukng remote-address=172.169.0.8
add disabled=yes local-address=172.169.0.1 name=idrmindosat1 password=\
    idrmindosat1 remote-address=172.169.0.7
...
add disabled=yes local-address=172.169.0.1 name=skbcicurug1 password=\
    skbcicurug1 remote-address=172.169.0.2
add disabled=yes local-address=33.33.33.1 name=prtg-padabeunghar password=\
    nasional remote-address=33.33.33.2
add disabled=yes local-address=172.169.0.1 name=palutungankng password=\
    palutungankng remote-address=172.169.0.10
add disabled=yes local-address=172.169.0.1 name=cibuntukng password=\
    cibuntukng remote-address=172.169.0.11
add disabled=yes local-address=172.169.0.1 name=nmsradio password=nmsradio \
    remote-address=172.169.0.200
add disabled=yes local-address=172.169.0.1 name=cangkinganidm password=\
    cangkinganidm remote-address=172.169.0.12
add local-address=172.169.0.1 name=pagelaran password=123 profile=\
    default-encryption remote-address=172.169.0.13
add disabled=yes local-address=172.169.0.1 name=cibodas password=cibodas \
    remote-address=172.169.0.9
add local-address=172.169.0.1 name=karangharja password=123 remote-address=\
    172.169.0.14
add disabled=yes local-address=172.169.0.1 name=cikadu password=123 \
    remote-address=172.169.0.15
add disabled=yes local-address=172.169.0.1 name=girijaya password=123 \
    remote-address=172.169.0.16
add disabled=yes local-address=172.169.0.1 name=anjatan password=123 \
...
add disabled=yes local-address=172.169.0.30 name=SBGCIERENG1 password=\
    nasional remote-address=172.169.0.31
add disabled=yes local-address=172.169.0.32 name=SBGCIERENG2 password=\
    nasional remote-address=172.169.0.33
add disabled=yes local-address=172.169.0.1 name=mitraraharja1 password=\
    P4ssword remote-address=172.169.0.18
add disabled=yes local-address=172.169.0.1 name=mitraraharja2 password=\
    P4ssword remote-address=172.169.0.19
add disabled=yes local-address=172.169.0.1 name=garut1 password=P4ssword \
    remote-address=172.169.0.20
add disabled=yes local-address=172.169.0.1 name=kbb5 password=P4ssword \
    remote-address=172.169.0.21
add disabled=yes local-address=172.169.0.1 name=bogor21 password=P4ssword \
    remote-address=172.169.0.23
add disabled=yes local-address=172.169.0.1 name=bogor17 password=P4ssword \
    remote-address=172.169.0.24
add disabled=yes local-address=172.169.0.1 name=bogor23 password=P4ssword \
    remote-address=172.169.0.25
add disabled=yes local-address=172.169.0.1 name=cianjur1 password=P4ssword \
    remote-address=172.169.0.26
add disabled=yes local-address=172.169.0.1 name=cianjur11a password=P4ssword \
    remote-address=172.169.0.27
add disabled=yes local-address=172.169.0.1 name=cianjur11b password=P4ssword \
    remote-address=172.169.0.28
add disabled=yes local-address=172.169.0.1 name=ciletuhmandiri password=\
    P4ssword remote-address=172.169.0.29
add disabled=yes local-address=172.169.0.1 name=cisoloknanelok password=\
    P4ssword remote-address=172.169.0.35
add disabled=yes local-address=172.169.0.1 name=rancabali password=P4ssword \
    remote-address=172.169.0.36
add disabled=yes local-address=172.169.0.1 name=karangmulya password=P4ssword \
    remote-address=172.169.0.34
add disabled=yes local-address=172.169.0.38 name=INDRAMAYU1 password=\
    nasional1 remote-address=172.169.0.39
add disabled=yes local-address=172.169.0.40 name=INDRAMAYU2 password=nasional \
    remote-address=172.169.0.41
add disabled=yes local-address=172.169.0.1 name=bekasi1 password=P4ssword \
    remote-address=172.169.0.43
add disabled=yes local-address=172.169.0.1 name=bekasi2 password=P4ssword \
...
add disabled=yes local-address=172.169.0.1 name=CIAMPEL password=P4ssword2022 \
...
add disabled=yes local-address=172.169.0.1 name=MAJALAYA password=\
    P4ssword2022 remote-address=172.169.0.52
...
add disabled=yes local-address=172.169.0.1 name=CICANTAYAN password=\
    P4ssword2022 remote-address=172.169.0.59
...
add disabled=yes local-address=172.169.0.1 name=GUNUNGMULYA password=\
    P4ssword2022 remote-address=172.169.0.62
...
add disabled=yes local-address=172.169.0.1 name=kbb6 password=P4ssword \
    profile=default-encryption remote-address=172.169.0.22
/snmp
