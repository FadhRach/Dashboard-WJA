# jun/15/2023 05:00:02 by RouterOS 6.49.7
...
set [ find default-name=ether6 ] name=ether6-TO_METRO_JAH_BU
/interface list
...
add max-limit=100M/100M name=ceres-vip packet-marks=mark-ceres-vip target=\
    172.16.250.0/24,172.16.251.0/24
add max-limit=100M/100M name=ceres-voip packet-marks=mark-ceres-voip target=\
    202.152.36.168/29
add max-limit=100M/100M name=ceres-cctv packet-marks=mark-ceres-cctv target="1\
    72.30.0.0/22,172.16.0.19/32,172.16.1.165/32,172.16.1.166/32,172.16.1.23/32\
    "
/ip hotspot user profile
...
/snmp community
set [ find default=yes ] addresses=0.0.0.0/0 name=cpepublic
...
set authentication=pap,chap,mschap1,mschap2 enabled=yes max-mru=1460 max-mtu=\
    1460
/ip address
add address=172.16.30.49/28 interface=ether2 network=172.16.30.48
add address=172.30.1.254/22 interface=ether5-TO_CCTV network=172.30.0.0
...
add address=10.100.3.6/30 disabled=yes interface=ether3- network=10.100.3.4
...
add address=10.100.3.6/30 interface=ether6-TO_METRO_JAH_BU network=10.100.3.4
/ip cloud
...
add address=172.16.251.0/24 list=ceres-delfi-vip
add address=172.16.250.0/24 list=ceres-delfi-vvip
add address=202.152.36.168/29 list=ceres-voip
add address=172.30.0.0/22 list=ceres-cctv
add address=172.16.0.19 list=ceres-cctv
add address=172.16.1.165 list=ceres-cctv
add address=172.16.1.166 list=ceres-cctv
add address=172.16.1.23 list=ceres-cctv
/ip firewall filter
...
add action=accept chain=forward disabled=yes dst-address=172.16.48.0/20 \
    src-address=172.16.1.3
...
add action=accept chain=forward dst-address=172.16.50.38 src-address=\
    172.16.1.30
add action=accept chain=forward dst-address=172.16.60.172 src-address=\
    172.16.2.183
...
add action=mark-connection chain=forward comment="CERES VIP" \
    dst-address-list=!private new-connection-mark=conn-ceres-vip passthrough=\
    yes src-address-list=ceres-delfi-vip
add action=mark-connection chain=forward dst-address-list=!private \
    new-connection-mark=conn-ceres-vip passthrough=yes src-address-list=\
    ceres-delfi-vvip
add action=mark-packet chain=forward connection-mark=conn-ceres-vip \
    new-packet-mark=mark-ceres-vip passthrough=no
add action=mark-connection chain=forward comment="CERES VOIP" \
    dst-address-list=!private new-connection-mark=conn-ceres-voip \
    passthrough=yes src-address-list=ceres-voip
add action=mark-packet chain=forward connection-mark=conn-ceres-voip \
    new-packet-mark=mark-ceres-voip passthrough=no
add action=mark-connection chain=forward comment="CERES CCTV" \
    dst-address-list=!private new-connection-mark=conn-ceres-cctv \
    passthrough=yes src-address-list=ceres-cctv
add action=mark-packet chain=forward connection-mark=conn-ceres-cctv \
    new-packet-mark=mark-ceres-cctv passthrough=no
/ip firewall nat
add action=passthrough chain=unused-hs-chain comment=\
    "place hotspot rules here" disabled=yes
...
/ppp secret
add local-address=172.18.9.1 name=DEMO password=P4ssword1234 remote-address=\
    172.18.9.2
add local-address=172.18.9.1 name=DEMO2 password=P4ssword1234 remote-address=\
    172.18.9.3
add local-address=172.18.9.1 name=DEMO3 password=P4ssword1234 remote-address=\
    172.18.9.4
add local-address=172.18.9.1 name=DEMO4 password=P4ssword1234 remote-address=\
    172.18.9.5
add local-address=172.18.9.1 name=DEMO5 password=P4ssword1234 remote-address=\
    172.18.9.6
/routing bgp network
...
add network=172.18.9.0/24 synchronize=no
/routing bgp peer
...
add in-filter=JAH-BACKUP name=JAH-BACKUP remote-address=10.100.3.5 remote-as=\
    64514
/routing filter
add action=accept chain=JAH prefix=0.0.0.0/0 set-bgp-prepend=10
add action=accept chain=JAH prefix=172.16.100.0/22 set-bgp-prepend=10
add action=accept chain=JAH prefix=172.16.128.0/22 set-bgp-prepend=10
add action=accept chain=JAH prefix=172.16.200.0/22 set-bgp-prepend=10
add action=accept chain=JAH prefix=172.18.0.0/24 set-bgp-prepend=10
add action=accept chain=JAH prefix=172.16.1.7 set-bgp-prepend=10
add action=accept chain=JAH prefix=172.16.1.9 set-bgp-prepend=10
add action=accept chain=JAH prefix=172.16.2.9 set-bgp-prepend=10
add action=accept chain=JAH prefix=172.16.2.12 set-bgp-prepend=10
add action=accept chain=JAH prefix=172.16.2.11 set-bgp-prepend=10
