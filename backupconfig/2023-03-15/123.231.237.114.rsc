# mar/15/2023 04:59:50 by RouterOS 6.48.4
...
add action=src-nat chain=srcnat comment="DESA CIBITUNG" dst-address=\
    172.169.0.71 dst-port=8291 protocol=tcp to-addresses=172.169.0.1
...
add action=src-nat chain=srcnat dst-address=172.169.0.72 dst-port=8291 \
    protocol=tcp to-addresses=172.169.0.1
...
add disabled=yes local-address=172.169.0.1 name=PINGKU password=P4ssword2023 \
...
add disabled=yes local-address=172.169.0.1 name=MEKARJAYA password=\
    P4ssword2023 remote-address=172.169.0.31
...
add disabled=yes local-address=172.169.0.1 name=SUGATEN password=P4ssword2023 \
...
add disabled=yes local-address=172.169.0.1 name=CIBODAS password=P4ssword2023 \
...
add disabled=yes local-address=172.169.0.1 name=CIOMAS password=P4ssword2023 \
...
add disabled=yes local-address=172.169.0.1 name=SUKATENANG password=\
    P4ssword2023 remote-address=172.169.0.76
...
add disabled=yes local-address=172.169.0.1 name=SUKAPURA password=\
    P4ssword2023 remote-address=172.169.0.84
add disabled=yes local-address=172.169.0.1 name=SALAGEDANG password=\
    P4ssword2023 remote-address=172.169.0.85
...
add disabled=yes local-address=172.169.0.1 name=NAGREGKENDAN password=\
    P4ssword2023 remote-address=172.169.0.88
add disabled=yes local-address=172.169.0.1 name=PANYADAP password=\
    P4ssword2023 remote-address=172.169.0.89
...
add disabled=yes local-address=172.169.0.1 name=PARUNG password=P4ssword2023 \
    remote-address=172.169.0.111
