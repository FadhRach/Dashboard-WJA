# mar/15/2023 04:59:10 by RouterOS 6.48.4
...
add comment="benns, faistby" distance=1 dst-address=172.16.50.78/32 gateway=\
    172.16.100.1
add distance=1 dst-address=172.16.60.0/24 gateway=10.100.3.10
add distance=1 dst-address=172.16.61.0/24 gateway=10.100.3.10
add distance=1 dst-address=172.16.62.0/24 gateway=10.100.3.10
add distance=1 dst-address=172.16.63.0/24 gateway=10.100.3.10
...
/routing bgp peer
add disabled=yes in-filter=MAIN name=TO-ROUTER-MAIN nexthop-choice=force-self \
