# sep/07/2022 11:04:17 by RouterOS 6.48.1
...
add name=Lo
/interface ethernet
set [ find default-name=sfp-sfpplus1 ] comment=TRK-BDGIDSSR01_LINE3
...
/interface vlan
add interface=sfp-sfpplus1 name="2020240085-SEKRETARIAT DAERAH" vlan-id=900
add interface=sfp-sfpplus1 name="2020240086-SEKRETARIAT DPRD" vlan-id=401
add interface=sfp-sfpplus1 name=2020240089-BAPPEDA vlan-id=403
add interface=sfp-sfpplus1 name=2020240091-BKD vlan-id=703
add interface=sfp-sfpplus1 name=2020240092-INSPEKTORAT vlan-id=402
add interface=sfp-sfpplus1 name=2020240094-BPSDM vlan-id=2551
...
add interface=sfp-sfpplus1 name=2020240180-DISDUKCAPIL vlan-id=451
add interface=sfp-sfpplus1 name=2020240182-DINKES vlan-id=113
add interface=sfp-sfpplus1 name=2020240184-DISDIK vlan-id=114
add interface=sfp-sfpplus1 name=2020240185-DISHUB vlan-id=634
add interface=sfp-sfpplus1 name=2020240186-DISPUSIPDA vlan-id=116
add interface=sfp-sfpplus1 name=2020240188-DISPARBUD vlan-id=633
add interface=sfp-sfpplus1 name=2020240189-BPBD vlan-id=118
add interface=sfp-sfpplus1 name="2020240190-BADAN PENGHUBUNG" vlan-id=119
...
add interface=sfp-sfpplus1 name="2020240196-CC PROVINSI" vlan-id=307
add interface=sfp-sfpplus1 name="2020240198-CC SATGAS CITARUM" vlan-id=404
...
add interface=sfp-sfpplus1 name=2020240222-RSJ vlan-id=2552
...
add interface=sfp-sfpplus1 name="2021240542-UPTD LAB LINGKUNGAN HIDUP" \
    vlan-id=306
...
add interface=sfp-sfpplus1 name="2021240548-UPTD LABKES" vlan-id=139
add interface=sfp-sfpplus1 name=2021240549-UPELKES vlan-id=103
add interface=sfp-sfpplus1 name="2021240823-CADISDIK WIL VIII" vlan-id=163
add interface=sfp-sfpplus1 name="2021240827-CADISDIK WIL IX" vlan-id=2347
...
add interface=sfp-sfpplus1 name="2021240844-BALAI TIKOMDIK" vlan-id=162
...
add interface=sfp-sfpplus1 name="2021240874-UPTD BPMKP" vlan-id=406
...
add interface=sfp-sfpplus1 name=2021240990-BPSBP vlan-id=408
add interface=sfp-sfpplus1 name="2021241000-BALAI PERLINDUNGAN PERKEBUNAN" \
    vlan-id=308
...
add interface=sfp-sfpplus1 name=2021241029-UPTD_PJJW_3 vlan-id=632
add interface=sfp-sfpplus1 name="2021241032-UPTD LAB BAHAN KONSTRUKSI" \
    vlan-id=305
...
add interface=sfp-sfpplus1 name=\
    "2021241343-UPTD PENGELOLAAN KEBUDAYAAN DAERAH" vlan-id=407
add interface=sfp-sfpplus1 name="2021241345-UPTD INDUSTRI LOGAM" vlan-id=121
add interface=sfp-sfpplus1 name="2021241346-UPTD IPOK" vlan-id=452
...
add interface=sfp-sfpplus1 name="2021241354-UPTD WASNAKER II BKS DAN KRW" \
    vlan-id=136
add interface=sfp-sfpplus1 name="2021241356-UPTD WASNAKER IV BDG" vlan-id=701
add interface=sfp-sfpplus1 name="2021241357-UPTD WASNAKER V TSK" vlan-id=147
add interface=sfp-sfpplus1 name="2021241515-BIRO BUMD" vlan-id=405
add interface=sfp-sfpplus1 name="2021241521-GEDUNG PKK" vlan-id=129
add interface=sfp-sfpplus1 name=2021241522-DEKRANASDA vlan-id=700
add interface=sfp-sfpplus1 name="2021241523-GUDANG DINKES" vlan-id=635
...
add interface=sfp-sfpplus1 name="2021244504-UPTD PP ASET" vlan-id=631
...
add interface=sfp-sfpplus1 name=CIUNG vlan-id=106
add interface=ether1 name=NMS vlan-id=101
add interface=ether1 name=NMS-PRTG vlan-id=199
add disabled=yes interface=sfp-sfpplus1 name=SEKDA_LPSE vlan-id=137
...
add max-limit=20M/20M name="BADAN TEKNOLOGI" target=\
    "2021240844-BALAI TIKOMDIK"
add max-limit=20M/20M name="DISDIK WIL X11" target=2021240832-UPTD_DISDIK_XII
add max-limit=100M/100M name=BAPENDA target=2020240193-BAPENDA
add max-limit=20M/20M name=BAPPEDA target=2020240089-BAPPEDA
add max-limit=800M/800M name=BKD target=2020240091-BKD
add max-limit=110M/110M name=BPBD target=2020240189-BPBD
add max-limit=210M/210M name=BPPD target=2020240191-BP2D
add max-limit=100M/100M name=BPSDM target=2020240094-BPSDM
add max-limit=100M/100M name="CC PROVINSI" target="2020240196-CC PROVINSI"
add max-limit=210M/210M name=DINKES target=2020240182-DINKES
add max-limit=100M/100M name=DISDIK target=2020240184-DISDIK
...
add max-limit=210M/210M name=DISPUSIPDA target=2020240186-DISPUSIPDA
...
add max-limit=160M/160M name=RS_JIWA target=2020240222-RSJ
add max-limit=110M/110M name=SATGAS_CITARUM target=\
    "2020240198-CC SATGAS CITARUM"
add max-limit=600M/600M name=SEKDA target="2020240085-SEKRETARIAT DAERAH"
add max-limit=100M/100M name=SEKRE_DPRD target="2020240086-SEKRETARIAT DPRD"
...
add max-limit=20M/20M name=UPTD_DISDIK_IX target="2021240827-CADISDIK WIL IX"
...
add max-limit=160M/160M name=UPTD_DINKES target=2021240549-UPELKES
...
add max-limit=20M/20M name=UPTD_INDUSTRI_PANGAN target="2021241346-UPTD IPOK"
...
add max-limit=165M/165M name=UPTD_P3LLAJ_IV target=\
...
add max-limit=100M/100M name=UPTD_PJJW_3 target=2021241029-UPTD_PJJW_3
...
add address=172.20.36.1/30 comment="DINKES_UPTD Pelatihan Kesehatan" \
    interface=2021240549-UPELKES network=172.20.36.0
add address=172.20.48.1/30 comment=\
    "DINSOS_UPTD Pengembangan dan Pelatihan Kesejahteraan Sosial " interface=\
    "2021240847-UPTD PPKS" network=172.20.48.0
add address=172.20.49.1/30 comment="DINSOS_UPTD Panti Sosial Rehabilitasi Peny\
    andang Disabilitas Mental, Sensorik Netra, Rungu Wicara, Tubuh " \
    interface="2021240859-UPTD PSRPD MENSENETRUWITU" network=172.20.49.0
add address=172.20.26.1/30 interface="2020240234-RSUD JAMPANG KULON" network=\
    172.20.26.0
add address=172.20.89.1/30 comment=\
    "DISNAKERTRANS_UPTD Balai Latihan Kerja Mandiri" interface=\
    "2021241351-BLK MANDIRI" network=172.20.89.0
...
add address=103.147.222.193/27 interface=SEKDA_LPSE network=103.147.222.192
...
add address=172.20.35.1/30 interface="2021240548-UPTD LABKES" network=\
    172.20.35.0
add address=172.20.41.1/30 interface="2021240827-CADISDIK WIL IX" network=\
    172.20.41.0
...
add address=172.20.60.1/30 interface="2021244485-CADISHUT WIL V" network=\
    172.20.60.0
add address=172.20.102.1/30 interface=sfp-sfpplus4 network=172.20.102.0
add address=172.20.105.1/30 network=172.20.105.0
add address=172.20.71.1/30 interface=2021241029-UPTD_PJJW_3 network=\
    172.20.71.0
...
add address=172.20.110.1/30 interface=CIUNG network=172.20.110.0
...
add action=masquerade chain=srcnat comment=NAT-ALL out-interface=sfp-sfpplus2 \
    to-addresses=103.122.5.150
...
add action=dst-nat chain=dstnat comment=\
    "2020240188-DINAS PARIWISATA DAN KEBUDAYAAN " dst-address=103.122.5.152 \
    dst-port=8115 protocol=tcp to-addresses=10.43.1.10 to-ports=8291
add action=src-nat chain=srcnat dst-address=10.43.1.10 dst-port=8291 \
    protocol=tcp to-addresses=172.20.15.2
add action=dst-nat chain=dstnat comment=\
...
add distance=1 dst-address=192.168.10.0/30 gateway=172.20.94.2
