# oct/15/2022 05:00:55 by RouterOS 6.48.1
...
set [ find default-name=sfp-sfpplus6 ] comment=TRK-BDGDISSR02_LINE2
/interface vlan
...
add interface=sfp-sfpplus6 name=SVLAN_3053 vlan-id=3053
add interface=sfp-sfpplus6 name=TEST1 vlan-id=69
add interface=sfp-sfpplus6 name=TEST2 vlan-id=70
add disabled=yes interface=sfp-sfpplus6 name=TEST3 vlan-id=3538
add interface=SVLAN_3053 name="test ciung 2" vlan-id=3538
add interface=SVLAN_3046 name=2020240184-DISDIK vlan-id=114
add interface=SVLAN_3053 name=2020240188-DISPARBUD vlan-id=633
...
add max-limit=110M/110M name=BKD target=2020240091-BKD
...
add address=172.20.114.1/30 interface=TEST1 network=172.20.114.0
add address=172.20.115.1/30 interface=TEST2 network=172.20.115.0
...
add address=172.20.116.1/30 interface="2022330816-UPTD MUARA CIASEM" network=\
    172.20.116.0
add address=172.20.118.1/29 interface="test ciung 2" network=172.20.118.0
/ip dns
