# aug/15/2023 05:00:03 by RouterOS 6.48
...
add action=src-nat chain=srcnat comment="NAT SIDOARJO - SAP RISE" \
    ...
    172.16.100.202
add action=src-nat chain=srcnat comment="SFTP WIRELESS NL" dst-address=\
    172.16.134.69 out-interface=ether1-TO_FORTI src-address=172.17.240.0/20 \
...
add action=src-nat chain=srcnat comment="SFTP WIRELESS CERES" dst-address=\
    172.16.134.69 out-interface=ether1-TO_FORTI src-address=172.16.240.0/20 \
    to-addresses=172.16.100.201
add action=src-nat chain=srcnat dst-address=172.16.134.150 out-interface=\
    ether1-TO_FORTI src-address=172.16.240.0/20 to-addresses=172.16.100.201
add action=src-nat chain=srcnat comment="SFTP WIRED NL" dst-address=\
...
add action=src-nat chain=srcnat comment="SFTP WIRED CERES" dst-address=\
    172.16.134.69 out-interface=ether1-TO_FORTI src-address=172.16.0.0/22 \
    to-addresses=172.16.100.201
add action=src-nat chain=srcnat dst-address=172.16.134.150 out-interface=\
...
add local-address=172.16.86.1 name=FAIRY password=P@55word7108 \
