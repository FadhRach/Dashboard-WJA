# sep/07/2022 10:59:21 by RouterOS 6.48.4
...
add action=dst-nat chain=dstnat comment="2021251540-UPT PENGUJIAN KIR" \
    ...
    172.168.1.2 to-ports=8291
add action=src-nat chain=srcnat dst-address=172.168.1.2 dst-port=8291 \
...
add action=src-nat chain=srcnat dst-address=172.168.1.158 dst-port=8291 \
    protocol=tcp to-addresses=172.168.1.1
