# dec/15/2022 05:00:16 by RouterOS 6.48.4
...
add action=dst-nat chain=dstnat comment="2021251540-UPT PENGUJIAN KIR" \
    dst-address=103.145.202.78 dst-port=8002 protocol=tcp to-ports=8291
...
add action=dst-nat chain=dstnat comment=\
    ...
    103.145.202.78 dst-port=8092 protocol=tcp to-addresses=172.168.1.98 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.168.1.98 dst-port=8291 \
    protocol=tcp to-addresses=172.168.1.1
add action=dst-nat chain=dstnat comment=\
...
add action=src-nat chain=srcnat dst-address=172.168.1.99 dst-port=8291 \
    protocol=tcp to-addresses=172.168.1.1
add action=dst-nat chain=dstnat comment="2022299178 - KIR KENDARAAN DISHUB " \
    dst-address=103.145.202.78 dst-port=8144 protocol=tcp to-addresses=\
...
add action=dst-nat chain=dstnat comment="CCTV Ledeng" dst-address=\
    ...
    to-ports=8291
add action=dst-nat chain=dstnat disabled=yes dst-address=103.145.202.78 \
    dst-port=8811 protocol=tcp to-addresses=172.168.1.111 to-ports=8811
...
add action=src-nat chain=srcnat dst-address=172.168.1.87 dst-port=8291 \
    protocol=tcp to-addresses=172.168.1.1
add action=dst-nat chain=dstnat comment="Lapangan Dadaha" dst-address=\
    103.145.202.78 dst-port=8220 protocol=tcp to-addresses=172.168.1.89 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.168.1.89 dst-port=8291 \
    protocol=tcp to-addresses=172.168.1.1
...
add action=src-nat chain=srcnat dst-address=172.168.1.161 dst-port=8291 \
    protocol=tcp to-addresses=172.168.1.1
add action=dst-nat chain=dstnat comment="2022331088 - TAMAN CIMARAGAS " \
...
add action=dst-nat chain=dstnat comment=\
    ...
    dst-port=8217 protocol=tcp to-addresses=172.168.1.200 to-ports=8291
add action=src-nat chain=srcnat dst-address=172.168.1.200 dst-port=8291 \
    protocol=tcp to-addresses=172.168.1.1
add action=src-nat chain=srcnat comment="DEPAN SMPN BANJAR" dst-address=\
    172.168.1.94 dst-port=8291 protocol=tcp to-addresses=172.168.1.1
add action=dst-nat chain=dstnat dst-address=103.145.202.78 dst-port=8208 \
    protocol=tcp to-addresses=172.168.1.94 to-ports=8291
add action=dst-nat chain=dstnat comment=\
...
add action=dst-nat chain=dstnat comment="Waduk Darma" dst-address=\
    ...
    to-ports=8291
add action=dst-nat chain=dstnat comment="Taman Sunset" dst-address=\
    103.145.202.78 dst-port=8206 protocol=tcp to-addresses=172.168.1.43 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.168.1.43 dst-port=8291 \
    protocol=tcp to-addresses=172.168.1.1
...
add action=src-nat chain=srcnat comment="Taman Sunset" dst-address=\
    172.168.1.43 dst-port=8291 protocol=tcp to-addresses=172.168.1.1
add action=dst-nat chain=dstnat comment="Graha Pariwisata" dst-address=\
    103.145.202.78 dst-port=8159 protocol=tcp to-addresses=172.168.1.48 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.168.1.48 dst-port=8291 \
    protocol=tcp to-addresses=172.168.1.1
add action=dst-nat chain=dstnat comment="UPT KENDARAAN UMUM" dst-address=\
    103.145.202.78 dst-port=8885 protocol=tcp to-addresses=172.168.1.85 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.168.1.85 dst-port=8291 \
    protocol=tcp to-addresses=172.168.1.1
add action=dst-nat chain=dstnat comment="DEWI TAPA CIRENDEU" dst-address=\
    103.145.202.78 dst-port=8215 protocol=tcp to-addresses=172.168.1.196 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.168.1.196 dst-port=8291 \
    protocol=tcp to-addresses=172.168.1.1
add action=dst-nat chain=dstnat comment=PAMARICAN dst-address=103.145.202.78 \
    dst-port=8209 protocol=tcp to-addresses=172.168.1.39 to-ports=8291
add action=src-nat chain=srcnat dst-address=172.168.1.39 dst-port=8291 \
    protocol=tcp to-addresses=172.168.1.1
add action=dst-nat chain=dstnat comment=PANUMBANGAN dst-address=\
    103.145.202.78 dst-port=8210 protocol=tcp to-addresses=172.168.1.38 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.168.1.38 dst-port=8291 \
    protocol=tcp to-addresses=172.168.1.1
add action=dst-nat chain=dstnat comment="GREEN CANYON PGD" dst-address=\
    103.145.202.78 dst-port=8211 protocol=tcp to-addresses=172.168.1.40 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.168.1.40 dst-port=8291 \
    protocol=tcp to-addresses=172.168.1.1
add action=dst-nat chain=dstnat comment=\
    "2021253727 - PANGANDARAN CREATIVE SPACE " dst-address=103.145.202.78 \
    dst-port=8212 protocol=tcp to-addresses=172.168.1.41 to-ports=8291
add action=src-nat chain=srcnat dst-address=172.168.1.41 dst-port=8291 \
    protocol=tcp to-addresses=172.168.1.1
add action=dst-nat chain=dstnat comment=\
    "2021253732 - TOURISM INFORMATION CENTER " dst-address=103.145.202.78 \
    dst-port=8213 protocol=tcp to-addresses=172.168.1.44 to-ports=8291
add action=src-nat chain=srcnat dst-address=172.168.1.44 dst-port=8291 \
    protocol=tcp to-addresses=172.168.1.1
add action=dst-nat chain=dstnat comment=\
    "2021256036 - AREA ISLAMIC CENTER/TERMINAL BANJAR " dst-address=\
    103.145.202.78 dst-port=8214 protocol=tcp to-addresses=172.168.1.95 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.168.1.95 dst-port=8291 \
    protocol=tcp to-addresses=172.168.1.1
add action=dst-nat chain=dstnat comment=" 2021253789 - ALUN-ALUN CICURUG " \
    dst-address=103.145.202.78 dst-port=8216 protocol=tcp to-addresses=\
    172.168.1.69 to-ports=8291
add action=src-nat chain=srcnat dst-address=172.168.1.69 dst-port=8291 \
    protocol=tcp to-addresses=172.168.1.1
add action=dst-nat chain=dstnat comment=\
    "2022313254 - ALUN-ALUN KECAMATAN PANCATENGAH " dst-address=\
    103.145.202.78 dst-port=8218 protocol=tcp to-addresses=172.168.1.34 \
    to-ports=8291
add action=src-nat chain=srcnat dst-address=172.168.1.34 dst-port=8291 \
    protocol=tcp to-addresses=172.168.1.1
add action=dst-nat chain=dstnat comment="2022299452 - REST AREA BANJAR ATAS" \
    dst-address=103.145.202.78 dst-port=8219 protocol=tcp to-addresses=\
    172.168.1.197 to-ports=8291
add action=src-nat chain=srcnat dst-address=172.168.1.197 dst-port=8291 \
    protocol=tcp to-addresses=172.168.1.1
/ip route
...
add distance=1 dst-address=1.6.208.17/32 gateway=*F pref-src=1.6.208.2 scope=\
    10
...
add local-address=172.168.1.1 name=pgd4 password=passwordpgd4 remote-address=\
    172.168.1.43
add local-address=1.6.0.29 name=CITATAH password=123 remote-address=1.6.0.47
/snmp
