# dec/15/2023 05:00:03 by RouterOS 6.49.7
...
add change-tcp-mss=yes dns-server=202.138.224.22,202.138.224.24 \
    ...
    use-encryption=yes
add change-tcp-mss=yes dns-server=172.16.1.29 name=DEMO
/queue simple
...
add address=100.100.100.2/24 interface=ether12 network=100.100.100.0
/ip cloud
...
add action=accept chain=forward dst-address=172.16.50.38 src-address=\
    172.16.1.30
add action=accept chain=forward dst-address=172.16.48.2 src-address=\
    172.16.1.30
add action=accept chain=forward dst-address=172.16.48.0/20 src-address=\
    172.16.1.30
add action=accept chain=forward dst-address=172.17.240.0/20 src-address=\
    172.16.1.30
add action=accept chain=forward dst-address=172.16.60.172 src-address=\
    172.16.2.183
add action=accept chain=forward dst-address=172.16.102.0/24 src-address=\
    172.16.240.0/22
...
/ppp secret
add local-address=172.18.15.1 name=DEMO1 password=P4ssword1234 profile=DEMO \
    remote-address=172.18.15.2
add local-address=172.18.15.1 name=DEMO2 password=P4ssword1234 profile=DEMO \
    remote-address=172.18.15.3
add local-address=172.18.15.1 name=DEMO3 password=P4ssword1234 profile=DEMO \
    remote-address=172.18.15.4
add local-address=172.18.15.1 name=DEMO4 password=P4ssword1234 profile=DEMO \
    remote-address=172.18.15.5
add local-address=172.18.15.1 name=DEMO5 password=P4ssword1234 profile=DEMO \
    remote-address=172.18.15.6
/routing bgp network
...
add network=172.18.15.0/24 synchronize=no
...
add action=accept chain=JAH prefix=::/128
...
add action=accept chain=JAH-BACKUP prefix=::/128
