# feb/15/2023 04:59:12 by RouterOS 6.48.4
...
add comment="benns, faistby" distance=1 dst-address=172.16.50.78/32 gateway=\
    172.16.100.1
add distance=2 dst-address=172.16.60.0/24 gateway=10.100.3.10
add distance=2 dst-address=172.16.61.0/24 gateway=10.100.3.10
add distance=2 dst-address=172.16.62.0/24 gateway=10.100.3.10
add distance=2 dst-address=172.16.63.0/24 gateway=10.100.3.10
...
/routing bgp peer
add default-originate=if-installed in-filter=MAIN name=MAIN nexthop-choice=\
    force-self remote-address=10.200.200.1 remote-as=64514 ttl=default
add default-originate=if-installed in-filter=SEMARANG-B/U name=SEMARANG-B/U \
    remote-address=10.100.3.18 remote-as=64518
add default-originate=if-installed in-filter=SIDOARJO-B/U name=SIDOARJO-B/U \
    remote-address=10.100.3.14 remote-as=64516 ttl=default
add default-originate=if-installed in-filter=CERES-B/U name=CERES-B/U \
    remote-address=10.100.3.6 ttl=default
add default-originate=if-installed in-filter=NL-B/U name=NL-B/U \
    remote-address=10.100.3.10 remote-as=64513 ttl=default
/routing filter
add action=accept chain=MAIN-IN disabled=yes prefix=172.20.0.32/29
add action=accept chain=MAIN-IN disabled=yes prefix=172.20.0.40/29
add action=accept chain=MAIN-IN disabled=yes prefix=172.20.0.48/29
add action=accept chain=MAIN-IN disabled=yes prefix=172.20.0.56/29
add action=accept chain=MAIN-IN disabled=yes prefix=172.20.0.160/29
add action=accept chain=MAIN-IN disabled=yes prefix=172.20.0.168/29
add action=accept chain=MAIN-IN disabled=yes prefix=172.20.0.176/29
add action=accept chain=MAIN-IN disabled=yes prefix=172.20.0.184/29
add action=accept chain=MAIN-IN disabled=yes prefix=172.20.3.0/29
add action=accept chain=MAIN-IN disabled=yes prefix=10.29.1.0/24
add action=accept chain=MAIN-IN disabled=yes prefix=172.20.6.0/29
add action=accept chain=MAIN-IN disabled=yes prefix=172.20.1.0/24 \
    prefix-length=24-32
add action=accept chain=MAIN-IN disabled=yes prefix=172.20.2.0/24 \
    prefix-length=24-32
add action=accept chain=MAIN-IN disabled=yes prefix=172.16.0.0/16 \
    prefix-length=16-32
add action=accept chain=MAIN-IN disabled=yes prefix=61.8.70.96/28
add action=accept chain=MAIN-IN disabled=yes prefix=182.23.32.0/29
add action=accept chain=MAIN-IN disabled=yes prefix=0.0.0.0/0
add action=discard chain=MAIN-IN disabled=yes
add action=accept chain=CERES-BACKUP disabled=yes prefix=172.20.0.32/29
add action=accept chain=CERES-BACKUP disabled=yes prefix=172.20.0.48/29
add action=accept chain=CERES-BACKUP disabled=yes prefix=172.20.0.56/29
add action=accept chain=CERES-BACKUP disabled=yes prefix=172.20.0.40/29
add action=discard chain=CERES-BACKUP disabled=yes
add action=accept chain=NL-BACKUP disabled=yes prefix=172.20.0.160/29
add action=accept chain=NL-BACKUP disabled=yes prefix=172.20.0.176/29
add action=accept chain=NL-BACKUP disabled=yes prefix=172.20.0.184/29
add action=accept chain=NL-BACKUP disabled=yes prefix=172.20.0.168/29
add action=discard chain=NL-BACKUP disabled=yes
add action=accept chain=SIDOARJO-BACKUP disabled=yes prefix=172.20.3.0/29
add action=accept chain=SIDOARJO-BACKUP disabled=yes prefix=10.29.1.0/24
add action=discard chain=SIDOARJO-BACKUP disabled=yes
add action=accept chain=SEMARANG-BACKUP disabled=yes prefix=172.20.6.0/29
add action=discard chain=SEMARANG-BACKUP disabled=yes
...
add action=accept chain=SEMARANG-B/U prefix=10.26.2.0/24
add action=discard chain=SEMARANG-B/U
add action=accept chain=SIDOARJO-B/U prefix=10.29.1.0/24
add action=discard chain=SIDOARJO-B/U
add action=accept chain=CERES-B/U prefix=172.16.0.0/22
add action=accept chain=CERES-B/U prefix=172.16.8.0/24
add action=accept chain=CERES-B/U prefix=172.16.240.0/20
add action=accept chain=CERES-B/U prefix=172.30.0.0/22
add action=discard chain=CERES-B/U
add action=accept chain=NL-B/U prefix=172.16.48.0/20
add action=accept chain=NL-B/U prefix=172.17.240.0/20
add action=discard chain=NL-B/U
add action=accept chain=MAIN prefix=0.0.0.0/0
add action=accept chain=MAIN prefix=10.0.0.0/8 prefix-length=8-32
add action=accept chain=MAIN prefix=172.16.0.0/16 prefix-length=16-32
add action=accept chain=MAIN prefix=172.17.0.0/16 prefix-length=16-32
add action=accept chain=MAIN prefix=172.18.0.0/16 prefix-length=16-32
add action=accept chain=MAIN prefix=172.30.0.0/16 prefix-length=16-32
add action=accept chain=MAIN prefix=182.23.0.0/16 prefix-length=16-32
add action=accept chain=MAIN prefix=202.152.0.0/16 prefix-length=16-32
add action=accept chain=MAIN prefix=123.231.0.0/16 prefix-length=16-32
add action=accept chain=MAIN prefix=61.8.0.0/16 prefix-length=16-32
