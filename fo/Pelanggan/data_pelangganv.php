...
<head>
    <meta charset="UTF-8">
    <title>DATA PELANGGAN WJA</title>
...
<? php 
  ...
  header("location:../Pelanggan/data_pelangganv.php");
}
   ?>
  <header id="header">
      <div class="header">
  ...
  <a class="active" href="data_pelangganv.php">Data Pelanggan</a>
  ...
  <a style="background-color: red;" href="../logout.php" onclick="return confirm('Apakah Anda Yakin Untuk Logout ?')">LOGOUT</a>
    ...
    <main>
      <div class="innertube">
     <h1 style="color: white; text-align: center;">Data Pelanggan GPON West Java Area</h1>
     <p align="center">
      ...
      <button style="background-color: red; color: white; padding-bottom: 0; padding-top: 0;" onclick="location.href='export_plgv.php'">Export Data</button>
     </p>
...
<tr>
   ...
   <th style="text-align: center;">Node Catuan</th>
   <th style="text-align: center;" width="80px;">Status</th>
        ...
        if (isset($_POST['kata_kunci'])) {
            ...
            $sql="select * from tb_pelanggan where nama_pelanggan like '%".$kata_kunci."%' or nomor_jaringan like '%".$kata_kunci."%' order by nomor_jaringan asc";

        }else {
            $sql="select * from tb_pelanggan order by nomor_jaringan asc";
        }
