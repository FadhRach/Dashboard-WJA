...
while ($row = mysqli_fetch_array($hasil)) {
            ...
            <tr>
                ...
                <td><a href="hapus_plg.php?id=<?php echo $row["nomor_jaringan"]; ?>" onclick="return confirm('Apakah Anda Yakin Untuk Menghapus Data Pelanggan ini ?')"><button><img style="height: 20px; width: 20px" src="hapus.png"></button></a></td>
