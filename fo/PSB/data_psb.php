...
<body>
 <? php 
  ...
  header("location:../PSB/data_psb.php");
}
   ?>
  <header id="header">
      <div class="header">
  ...
  <a class="active" href="data_psb.php">Data PSB</a>
  ...
  <a style="background-color: red;" href="../logout.php" onclick="return confirm('Apakah Anda Yakin Untuk Logout ?')">LOGOUT</a>
    ...
    <main>
      <div class="innertube">
     <h1 style="color: red; text-align: center;">Data PSB Fiber Optic West Java Area</h1>
     <p align="center">
      <button style="background-color: red; color: white; padding-bottom: 0; padding-top: 0;" onclick="location.href='../PSB/form_psb.php'">+ Add Data</button>
      <button style="background-color: red; color: white; padding-bottom: 0; padding-top: 0;" onclick="location.href='export_psb.php'">Export Data</button>
     </p>
...
<tr>
   ...
   <th style="text-align: center;" width="100px;">Nama Pelanggan</th>
   <th style="text-align: center;" width="200px;">Alamat</th>
   <th style="text-align: center;">Jasa</th>
   <th style="text-align: center;">Catuan Splitter</th>
   <th style="text-align: center;" width="30px;">Port Splitter</th>
   <th style="text-align: center;" width="80px;">Mitra</th>
   <th style="text-align: center;" width="50px;">Panjang Tarikan (m)</th>
   <th style="text-align: center;" width="80px;">Tanggal Instalasi</th>
   <th style="text-align: center;">Hapus</th>
        ...
        if (isset($_POST['kata_kunci'])) {
            ...
            $sql="select * from tb_psb where nama_pelanggan like '%".$kata_kunci."%' or nomor_jaringan like '%".$kata_kunci."%' order by nomor_jaringan desc";

        }else {
            $sql="select * from tb_psb order by nomor_jaringan desc";
        }
...
while ($row = mysqli_fetch_array($hasil)) {
            ...
            <tr>
                ...
                <td><?php echo $row["splitter"];   ?></td>
                <td><?php echo $row["port_splitter"];   ?></td>
                <td><?php echo $row["mitra"];   ?></td>
                <td><?php echo $row["panjang_FO"];   ?></td>
                <td><?php echo $row["tanggal"];   ?></td>
                <td><a href="hapus_psb.php?id=<?php echo $row["nomor_jaringan"]; ?>" onclick="return confirm('Apakah Anda Yakin Untuk Menghapus Data Pelanggan ini ?')"><button><img style="height: 20px; width: 20px" src="../Pelanggan/hapus.png"></button></a></td>
