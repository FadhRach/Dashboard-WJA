...
<body>
  ...
  <a class="active" href="ganti_pass.php">Ganti Password</a>
  ...
  <a style="background-color: red;" href="../logout.php" onclick="return confirm('Apakah Anda Yakin Untuk Logout ?')">LOGOUT</a>
    ...
    if ($sql) {
        echo "<script language='JavaScript'>
            ...
            document.location='../Data Splitter/view.php';
            </script>";    
    } else {
        echo "<script language='JavaScript'>
...
<tr>
   <td align="center" colspan="2" ><input type="submit" name="Ganti" value="SUBMIT"><input type="button" name="batal" value="BATAL" onclick="javascript:window.location='ganti_pass.php';"></td>
</tr>
