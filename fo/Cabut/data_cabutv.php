...
<? php 
  ...
  header("location:../Cabut/data_cabutv.php");
}
   ?>
  <header id="header">
      <div class="header">
  ...
  <a href="form_cabutv.php">Form Cabut</a>
  <a class="active" href="data_cabutv.php">Data Cabut</a>
  <a href="../Peta/petav.php">Peta Splitter</a>
  <a href="../User/ganti_pass.php">Ganti Password</a>
  <a style="width:400px; font-family: calibri; font-size: 10; text-align: right;"><?php session_start(); echo "Selamat datang ". $_SESSION['username'];  ?></a>
