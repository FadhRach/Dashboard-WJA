...
<body>
  ...
  <a style="width:4000px; font-family: calibri; font-size: 10; text-align: right; color: aqua;">PT. Aplikanusa Lintasarta</a>
     ...
     <h1 style="color: white; text-align: center;">Lihat data Splitter</h1>
        ...
        <table align="center" style="color: white; font-size: 14; font-family: sans-serif;" >
            ...
            <tr style="height: 50px">
                <td align="center" colspan="2" style="background-color:rgb(0, 0, 0, 0.6);"><input type="button" name="batal" value="KEMBALI" onclick="javascript:window.location='view.php';"></td>
            </tr>
        </table>
    </form>
      </div>
