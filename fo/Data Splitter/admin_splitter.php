...
?>
  ...
  <main>
      ...
      <p align="center">
      <button style="background-color: red; color: white; padding-bottom: 0; padding-top: 0;" onclick="location.href='add_splitter.php'">+ Add Splitter</button>
      <button style="background-color: red; color: white; padding-bottom: 0; padding-top: 0;" onclick="location.href='export.php'">Export Data</button>
      </p>
      ...
      <table border="1" width="800px">
          <tr>
            ...
            <th colspan="2" style="text-align: center;">Edit  | Hapus</th>
          </tr>
          ...
          ?>
                  ...
                  <tr>
                      ...
                      <td><a href="update_splitter.php?id=<?php echo $row["nama_splitter"]; ?>"><button><img style="height: 20px; width: 20px" src="edit.png"></button></a></td>
                      <td><a href="hapus.php?id=<?php echo $row["nama_splitter"]; ?>" onclick="return confirm('Apakah Anda Yakin Untuk Menghapus Data Splitter ini ?')"><button><img style="height: 20px; width: 20px" src="../Pelanggan/hapus.png"></button></a></td>
                  </tr>
                  </tbody>
          <?php
          }
